...
import com.kosnik.repository.DynamicQueryCardRepository;
...
public class DynamicQueryCardRepositoryImpl implements DynamicQueryCardRepository {

    private final MongoTemplate mongoTemplate;
    @Override
    public Page<Card> findAll(SearchQuery searchQuery, final Pageable pageable) {
